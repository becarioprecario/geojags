...
void BugsDistTest::setUp() {
    ...
    _dmnormtwo = new jags::bugs::DMNormtwo();
...
void BugsDistTest::npar()
{
    ...
    CPPUNIT_ASSERT_EQUAL(_dmnormtwo->npar(), 2U);
...
void BugsDistTest::name()
{
    ...
    CPPUNIT_ASSERT_EQUAL(string("dmnormtwo"), _dmnorm2->name());
...
void BugsDistTest::alias()
{
    ...
    CPPUNIT_ASSERT_EQUAL(string(""), _dmnormtwo->alias());
