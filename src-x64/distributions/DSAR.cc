...
double DSAR::logDensity(double const *x, unsigned int m, PDFType type,
...
void DSAR::randomSample(double *x, unsigned int m,
			  vector<double const *> const &parameters,
			  vector<vector<unsigned int> > const &dims,
...
void DSAR::randomsample(double *x, double const *mu, double const *T,
...
void DSAR::support(double *lower, double *upper, unsigned int length,
		     vector<double const *> const &parameters,
		     vector<vector<unsigned int> > const &dims) const
{
...
void DSAR::typicalValue(double *x, unsigned int m,
			  vector<double const *> const &parameters,
			  vector<vector<unsigned int> > const &dims,
			  double const *lower, double const *upper) const
{
