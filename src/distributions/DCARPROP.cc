...
DCARPROP::DCARPROP()
  : ArrayDist("dcarprop", 4) //mu, W, rho, tau
{}

double DCARPROP::logDensity( double const                         *x, 
                             unsigned int                         m, 
                             PDFType                              type,
                             ...
                             double const                         *upper ) const
{
    ...
    create_IrhoW3(Tcopy, T, m, rho[0], tau[0]);
...
void DCARPROP::randomSample( double                               *x, 
                             unsigned int                         m,
			                       vector<double const *> const         &parameters,
			                       vector<vector<unsigned int> > const  &dims,
			                       double const                         *lower, 
...
bool DCARPROP::checkParameterDim( vector<vector<unsigned int> > const &dims ) const
{
...
vector<unsigned int> DCARPROP::dim( vector<vector<unsigned int> > const &dims ) const
{
    return dims[0];
}

bool
DCARPROP::checkParameterValue( vector<double const *> const         &parameters,
...
void DCARPROP::support( double                               *lower, 
                        double                               *upper, 
                        unsigned int                         length,
		                    vector<double const *> const         &parameters,
		                    vector<vector<unsigned int> > const  &dims ) const
...
void DCARPROP::typicalValue( double                               *x, 
                             unsigned int                         m,
			                       vector<double const *> const         &parameters,
			                       vector<vector<unsigned int> > const  &dims,
			                       double const                         *lower, 
...
bool DCARPROP::isSupportFixed( vector<bool> const &fixmask ) const
{
    return true;
}
